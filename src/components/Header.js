  ...
  return (
    <>
      <Disclosure as="nav" className="bg-gray-800">
        {({ open }) => (
          <>
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-14">
                      ...
                      {navigation.map((item) => (
                        <NavLink
                          ...
                          className={({isActive}) => {
                            ...
                            return (isActive ? "no-underline bg-gray-900 text-white" : "no-underline text-gray-300 hover:bg-gray-700 hover:text-white")
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <a
                              href="#"
                              className={classNames(
                                active ? "no-underline bg-gray-100" : "",
